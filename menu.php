                    ...
                    <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน ระบบขาย</a>
                     ...
                     <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน ระบบซื้อ</a>
                    	<ul class="dropdown-menu">
                            ...
                            <li><a href="index.php?content=sale_summary"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน สรุปสินค้าค้างรับ แยกตามรุ่นสินค้า(ห้ามใช้)</a></li>
                            <li><a href="index.php?content=sale_summary"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน สรุปสินค้าค้างรับ แยกตามรายการสินค้า(ห้ามใช้)</a></li>
                            <li><a href="index.php?content=sale_summary"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน สรุปสินค้าค้างรับ แยกตามผู้ขาย(ห้ามใช้)</a></li>
                            <li class="divider"></li>
